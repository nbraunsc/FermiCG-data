...
function run_cmf_fci(d_guess=nothing)
    molecule = "
    ...
    n_clusters = 6
    #cluster_list = [[1,7], [2,3,4,5], [6,12], [8,9,10,11]]
    ...
    display(clusters)
    #init_cluster_ansatz = [FCIAnsatz(2,2,2), FCIAnsatz(4,2,2), FCIAnsatz(2,0,0), FCIAnsatz(4,2,2)]
    ...
    if d_guess == nothing
        ...
        C_cmf = Cact*U_cmf
        @save "/Users/nicole/My Drive/code/FermiCG-data/two_benzene/cmf_fci.jld2" ints_cmf U_cmf d1 e_cmf ansatze init_fspace clusters
        pyscf.tools.molden.from_mo(pymol, "/Users/nicole/My Drive/code/FermiCG-data/two_benzene/C_cmf_fci.molden", C_cmf)
        return e_cmf
    
    else
        @load "/Users/nicole/My Drive/code/FermiCG-data/two_benzene/ints_diis.jld2"
        ints = ints_cmf
        #run cmf_oo
        ...
        ints_cmf = orbital_rotation(ints,U_cmf)
        C_cmf = Cact*U_cmf
        @save "/Users/nicole/My Drive/code/FermiCG-data/two_benzene/cmf_fci.jld2" ints_cmf U_cmf d1 e_cmf C_cmf
        pyscf.tools.molden.from_mo(pymol, "/Users/nicole/My Drive/code/FermiCG-data/two_benzene/C_cmf_fci.molden", C_cmf)
        return e_cmf
    end
end
