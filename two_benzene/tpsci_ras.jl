...
ci_vector[FermiCG.FockConfig(init_fspace)][FermiCG.ClusterConfig([5,1])] = zeros(Float64,nroots)
ci_vector[FermiCG.FockConfig(init_fspace)][FermiCG.ClusterConfig([1,5])] = zeros(Float64,nroots)
ci_vector[FermiCG.FockConfig(init_fspace)][FermiCG.ClusterConfig([6,1])] = zeros(Float64,nroots)
ci_vector[FermiCG.FockConfig(init_fspace)][FermiCG.ClusterConfig([1,6])] = zeros(Float64,nroots)
ci_vector[FermiCG.FockConfig(init_fspace)][FermiCG.ClusterConfig([7,1])] = zeros(Float64,nroots)
ci_vector[FermiCG.FockConfig(init_fspace)][FermiCG.ClusterConfig([1,7])] = zeros(Float64,nroots)
...
@save "/Users/nicole/My Drive/code/FermiCG-data/two_benzene/ras_tpsci.jld2" cluster_bases e0b v0b s2 ecore
