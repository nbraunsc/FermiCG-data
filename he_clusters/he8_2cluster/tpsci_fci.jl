...
cluster_bases = FermiCG.compute_cluster_eigenbasis_spin(ints, clusters, d1, [6,2,6,6,2,6], ref_fock, ansatze, max_roots=M, verbose=0);
#
#cluster_bases = FermiCG.compute_cluster_eigenbasis(ints, clusters, init_fspace=init_fspace, delta_elec=8, max_roots=M, rdm1a=d1.a, rdm1b=d1.b, verbose=0); #not spin completed!
...
@save "/Users/nicole/My Drive/code/FermiCG-data/he_clusters/he8_2cluster/fci_tpsci_notspincompleted_extradim_m118.jld2" cluster_bases e0b v0b s2 ecore
#@save "/Users/nicole/My Drive/code/FermiCG-data/he_clusters/he8_2cluster/fci_tpsci_spincompleted_extradim_m118.jld2" cluster_bases e0b v0b s2 ecore
