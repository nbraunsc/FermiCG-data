...
#thresh = [0.1, 0.01, 0.005, 0.001, 0.0001]
#thresh = [0.0005, 0.0007]

#thresh = [0.0008, 0.0006, 0.0004]
#for i in thresh
...
clip!(v0, thresh=0.0006)
e0, v11 = FermiCG.tps_ci_direct(v0, cluster_ops, clustered_ham)
...
@save "/home/nbraunsc/FermiCG-data/excited_paper/tt/thresh_0006.jld2" clusters cluster_bases e0 v11 e2 s2 ecore

clip!(v11, thresh=0.0008)
e0, v1 = FermiCG.tps_ci_direct(v11, cluster_ops, clustered_ham)
...
@save "/home/nbraunsc/FermiCG-data/excited_paper/tt/thresh_0008.jld2" clusters cluster_bases e0 v1 e2 s2 ecore

#    #@time e2 = FermiCG.compute_pt2_energy(ci_vector, cluster_ops, clustered_ham, thresh_foi=1e-8);
#    @time e2 = FermiCG.compute_pt2_energy(v0, cluster_ops, clustered_ham, thresh_foi=1e-8);
#    name = "thresh_"*string(i)*".jld2"
#    
#    clustered_S2 = FermiCG.extract_S2(ci_vector.clusters)
#
#    println()
...
@save "/home/nbraunsc/FermiCG-data/tetracene_tetramer/cluster_3_N40/M20.jld2" clusters d1 ints C cluster_bases ci_vector e0 v0 e2  
...
e0, v0 = FermiCG.tpsci_ci(ci_vector, cluster_ops, clustered_ham,
                            ...
                            incremental=false);	# turn this off,  as it wasn't well tested for multistate
@time e2 = FermiCG.compute_pt2_energy(v0, cluster_ops, clustered_ham, thresh_foi=1e-8);
@save "/home/nbraunsc/FermiCG-data/tetracene_tetramer/cluster_3_N40/M40.jld2" clusters d1 ints C cluster_bases ci_vector e0 v0 e2
...
e0, v0 = FermiCG.tpsci_ci(ci_vector, cluster_ops, clustered_ham,
                            ...
                            max_iter=10);
@time e2 = FermiCG.compute_pt2_energy(v0, cluster_ops, clustered_ham, thresh_foi=1e-8);
@save "/home/nbraunsc/FermiCG-data/tetracene_tetramer/cluster_3_N40/M60.jld2" clusters d1 ints C cluster_bases ci_vector e0 v0 e2 
...
e0, v0 = FermiCG.tpsci_ci(ci_vector, cluster_ops, clustered_ham,
                            ...
                            max_iter=10);
@time e2 = FermiCG.compute_pt2_energy(v0, cluster_ops, clustered_ham, thresh_foi=1e-8);
@save "/home/nbraunsc/FermiCG-data/tetracene_tetramer/cluster_3_N40/M80.jld2" clusters d1 ints C cluster_bases ci_vector e0 v0 e2 
...
e0, v0 = FermiCG.tpsci_ci(ci_vector, cluster_ops, clustered_ham,
                            ...
                            max_iter=10);
@time e2 = FermiCG.compute_pt2_energy(v0, cluster_ops, clustered_ham, thresh_foi=1e-8);
@save "/home/nbraunsc/FermiCG-data/tetracene_tetramer/cluster_3_N40/M100.jld2" clusters d1 ints C cluster_bases ci_vector e0 v0 e2
