...
@load "/home/nbraunsc/FermiCG-data/excited_paper/tt/new_dav_tucker_thresh_0.0006.jld2"
...
for i in tucker
    ...
    name = "new_dav_tucker_thresh_"*string(i)*".jld2"
    ...
    @save "/home/nbraunsc/FermiCG-data/excited_paper/tt/"*string(name) cluster_bases e0b v0b e2 s2
