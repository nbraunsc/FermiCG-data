...
# define clusters
cluster_list = [collect(1:14), collect(15:28)]
...
# Build Cluster basis
cluster_bases = FermiCG.compute_cluster_eigenbasis_spin(ints, clusters, d1, [1, 1], ref_fock, max_roots=M, verbose=1);
#
# Build ClusteredOperator
clustered_ham = FermiCG.extract_ClusteredTerms(ints, clusters)
display(clustered_ham)

@save "dimer_ham.jld2" clusters clustered_ham
