...
@load  "/home/nbraunsc/FermiCG-data/excited_paper/p5/tucker_thresh_46_0.0006.jld2"
...
for i in tucker
    ...
    name = "tucker_thresh_46_"*string(i)*".jld2"
    ...
    @save "/home/nbraunsc/FermiCG-data/excited_paper/p5/"*string(name) cluster_bases e0b v0b e2 s2
