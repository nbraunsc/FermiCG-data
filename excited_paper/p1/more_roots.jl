...
#ctx = fcidump.read("/home/nbraunsc/FermiCG-data/excited_paper/p1/fcidump_4mer");
#h = ctx["H1"];
#g = ctx["H2"];
#ecore = ctx["ECORE"];
...
#@save  "/home/nbraunsc/FermiCG-data/excited_paper/p1/cmf_diis.jld2" ints d1 clusters init_fspace
...
for i in thresh
    ...
    @save "/home/nbraunsc/FermiCG-data/excited_paper/p1/"*string(name) clusters d1 ints cluster_bases ci_vector e0 v0 e2 ecore s2
end
