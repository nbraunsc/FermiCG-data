...
#ctx = fcidump.read("/home/nbraunsc/FermiCG-data/excited_paper/p4/qdphenyl-fcidump");
#h = ctx["H1"];
#g = ctx["H2"];
#ecore = ctx["ECORE"];
...
#@save  "/home/nbraunsc/FermiCG-data/excited_paper/p4/cmf_diis.jld2" ints d1 clusters init_fspace
@load  "/home/nbraunsc/FermiCG-data/excited_paper/p4/cmf_diis.jld2"
ecore = ints.h0
...
for i in thresh
    ...
    @save "/home/nbraunsc/FermiCG-data/excited_paper/p4/"*string(name) clusters d1 ints cluster_bases ci_vector e0 v0 e2 ecore s2
end
